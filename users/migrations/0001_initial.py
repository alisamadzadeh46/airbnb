# Generated by Django 4.0.1 on 2022-05-24 13:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_login', models.DateTimeField(blank=True, null=True, verbose_name='last users')),
                ...
                ('language', models.CharField(blank=True, choices=[('en', 'English'), ('tu', 'Turkish')], max_length=2)),
                ('currency', models.CharField(blank=True, choices=[('en', 'English'), ('tu', 'Turkish')], max_length=2)),
